...
class Parameters:
    ...
    Attributes:
        ...
        lifespan_mean (int, float): The mean cell lifespan in number of generations drawn from an exponential distribution. Corresponds to 1/r, where r is the rate parameter of the exponential. A value of 1 will fix the lifespan to 1 generation for all cells. **Default: 1**
